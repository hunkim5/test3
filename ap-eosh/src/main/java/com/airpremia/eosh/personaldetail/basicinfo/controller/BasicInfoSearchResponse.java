...
@Getter
@NoArgsConstructor
public class BasicInfoSearchResponse {
    ...
    public BasicInfoSearchResponse(BasicInfoDto dto) {
        this.userSeq = dto.getUserSeq();
        this.userId = dto.getUserId();
        this.userGradeEnum = dto.getUserGradeEnum();
        this.userJobClassificationClassificationEnum = dto.getUserJobClassificationClassificationEnum();
        this.empNm = dto.getEmpNm();
        this.empNo = dto.getEmpNo();
        this.postNm = dto.getPostNm();
        this.deptNm = dto.getDeptNm();
        this.hireYmd = dto.getHireYmd();
        this.birthYmd = dto.getBirthYmd();
        this.email = dto.getEmail();
        this.handphone = dto.getHandphone();
    }
}
