...
public class MeetingSearchRequest {
    ...
    public MeetingSearchDto convertMeetingSearchDto() {
        MeetingSearchDto data = new MeetingSearchDto();
        data.setMeetingSeq(this.meetingSeq);
        data.setCommitteeEnum(this.committeeEnum);
        data.setRepresentativeMeetingUserName(this.representativeMeetingUserName);
        data.setMeetingDt(this.meetingDt);
        data.setMeetingCheckDt(this.meetingCheckDt);
        data.setMeetingSubject(this.meetingSubject);
        data.setMeetingContent(this.meetingContent);
        data.setMeetingLocationComment(this.meetingLocationComment);
