...
@Getter
@NoArgsConstructor
public class MeetingAttendUserResponse {
    ...
    public MeetingAttendUserResponse(MeetingAttendUserDto req) {
    ...
    public MeetingAttendUserResponse(MeetingAttendUserRequest req) {
        this.meetingAttendUserSeq = req.getMeetingAttendUserSeq();
        this.meetingSeq = req.getMeetingSeq();
        this.committeeEnum = req.getCommitteeEnum();
        this.externalBool = req.isExternalBool();
