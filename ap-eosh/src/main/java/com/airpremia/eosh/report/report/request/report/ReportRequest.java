...
import com.airpremia.eosh.report.report.request.accessaircraft.ReportAccessAircraftInformationRequest;
import com.airpremia.eosh.report.report.request.flightcrew.ReportFlightInformationCrewRequest;
import com.airpremia.eosh.report.report.request.flightinformation.ReportFlightInformationRequest;
import com.airpremia.eosh.report.report.request.wildlife.ReportWildlifePartStatusRequest;
...
public class ReportRequest {
    ...
    private List<ReportWildlifePartStatusRequest> reportWildlifePartStatusList;
    private ReportSourceEnum reportSourceEnum = ReportSourceEnum.REPORT;
    private ReportFlightInformationRequest flightInformation;
    private List<ReportFlightInformationCrewRequest> flightInformationCrewList;
    private List<ReportAccessAircraftInformationRequest> reportAccessAircraftInformationList;
}
