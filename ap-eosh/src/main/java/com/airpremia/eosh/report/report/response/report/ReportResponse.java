...
import com.airpremia.eosh.report.report.response.accessaircraft.ReportAccessAircraftInformationResponse;
import com.airpremia.eosh.report.report.response.flightcrew.ReportFlightInformationCrewResponse;
import com.airpremia.eosh.report.report.response.flightinformation.ReportFlightInformationResponse;
import com.airpremia.eosh.report.report.response.wildlife.ReportWildlifePartStatusResponse;
...
public class ReportResponse {
    ...
    private List<ReportWildlifePartStatusResponse> reportWildlifePartStatusList;
    private HrEmpDto reportUserInfo;
    private ReportFlightInformationResponse flightInformation;
    private List<ReportFlightInformationCrewResponse> flightInformationCrewList;
    private List<ReportAccessAircraftInformationResponse> reportAccessAircraftInformationList;
}
