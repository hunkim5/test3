...
@Getter
@NoArgsConstructor
public class AuthorityManagementUpdateResponse {
    ...
    public AuthorityManagementUpdateResponse(AuthorityManagementUpdateRequest request) {
        this.userId = request.getUserId();
        this.userGradeEnum = request.getUserGradeEnum();
    }

    public AuthorityManagementUpdateResponse(AuthorityManagementUpdateDto dto) {
